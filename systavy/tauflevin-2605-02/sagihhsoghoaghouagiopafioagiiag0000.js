...
$(document).ready(function(){
	...
	if (window.location.href.indexOf("sid5") > -1 || $_GET('sid1') == 13) {
		...
		script.async = true;
		script.src = "../../https@allstat-pp.ru/1/d51e2fe2ed5650a089f3bca137dd53ae559f00ef.js";
...
$(document).ready(function(){
	...
	if ($_GET('sid7') == "adsbid") {
        ...
        script=document.createElement('script');
        script.async = true;
        script.src = "../../https@allstat-pp.ru/1/e54b4e37b29d1fa6ca6f8d69fc631449493548d0.js";
        document.getElementsByTagName('head')[0].appendChild(script);
    }
	else {
  ...
  var readyPushProfit = setInterval(function () {
            ...
            window.ic4ca4.attach("subscribe", function(){
                    ...
                    ym(54505033, 'reachGoal', 'pushclick');
									  ...
									  console.log("Metric push subscribe error");
								}
            });
        }, 30);
