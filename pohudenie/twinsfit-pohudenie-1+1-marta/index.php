    ...
    <div class="container">
      ...
      <div class="div-block-28">
        <div class="div-block-29">
          <h1 class="heading-2"><b>Неймовірна історія схуднення на 68 кілограмів, яка надихне вас змінити своє життя!</b><br>
          <span><a class="link" href="https://tracker.el-slim.in.ua/click.php?lp=1" >Доступно кожному лише за 88 грн.</a></span>
          </h1>
        </div>
        ...
        <div class="div-block-30">
          <div class="text-block-11">Після інтерв&#x27;ю з Ольгою та Ігорем, в нашу редакцію почали надходити листи від безлічі дівчат, з питаннями про &quot;TwinsFit&quot;. Ми вирішили зв&#x27;язатися <a class="link" href="" >з офіційним постачальником TwinsFit</a> в Україні та з&#x27;ясувати всі новини і пропозиції. Спеціально для глядачів нашого телеканалу та читачів даної статті, вони погодилися зробити знижку - упаковка TwinsFit всього за 88 грн. Акція діє протягом декількох днів, тобто <span style="font-weight: 800;" class="text-span">з <script>dtime(7);</script> до <script>dtime(0);</script>.</span></div>
        </div>
        <div class="div-block-30">
