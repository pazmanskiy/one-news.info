function menu(e) {
    let target = e.target;
    let body = document.querySelector("#main_loader");
    if (target.closest(".openmenu") != null || target.classList.contains("openmenu")) {
        body.classList.toggle("menu-div-sub-opened");
        return;
    }
    if (target.classList.contains("js--menu-close")) {
        body.classList.remove("menu-div-sub-opened");
    }
}
